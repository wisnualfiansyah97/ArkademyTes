        ...
        <div class="col-sm-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="position: center">
                                                <a href="<?php echo base_url('Home/ubah/').$key['id'];?>" type="button" class="btn btn-primary" style="text-align: right;">Edit</a>
                                                <a href="<?php echo site_url('Home/hapus/').$key['id'];?>" onclick="javascript:return confirm('Apakah anda yakin ingin menghapus ?')" type="button" class="btn btn-danger" style="text-align: right;">Hapus</a>  
                                          </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
            ...
            <div class="col-sm-4">
                <div class="panel panel-primary" style="width: 500px; " >
                    <div class="panel-heading" style="text-align: center;">EDIT PRODUK
                        <span class="pull-right clickable panel-toggle"><em class="fa fa-toggle-up"></em></span>
                    </div>
                <div class="panel-body">
                    <form action="<?php echo base_url('Home/proses_ubah/').$data['id'];?>" method="post">   
                        <div class="form-group">  
                          <label class="control-label" for="pswd">Nama Produk</label>  
                            <div>  
                              <input type="text" class="form-control" id="namaProduk" name="namaProduk" placeholder="namaProduk" required="" value="<?php echo $data['nama']; ?>">  
                            </div>  
                        </div>  
                         <div class="form-group">  
                          <label class="control-label" for="pswd">Keterangan Produk</label>  
                            <div>  
                              <input type="text" class="form-control" id="ketProduk" name="ketProduk" placeholder="ketProduk" required="" value="<?php echo $data['keterangan']; ?>">  
                            </div>  
                        </div>  
                         <div class="form-group">  
                          <label class="control-label" for="pswd">Harga Produk</label>  
                            <div>  
                              <input type="text" class="form-control" id="hargaProduk" name="hargaProduk" placeholder="hargaProduk" required="" value="<?php echo $data['harga']; ?>">  
                            </div>  
                        </div>  
                         <div class="form-group">  
                          <label class="control-label" for="pswd">Jumlah Produk</label>  
                            <div>  
                              <input type="text" class="form-control" id="jumlahProduk" name="jumlahProduk" placeholder="jumlahProduk" required="" value="<?php echo $data['jumlah']; ?>">  
                            </div>  
                        </div>  
                        <div class="form-group">   
                          <div class="row">  
                            <div class="col-sm-offset-5 col-sm-3 btn-submit">  
                              <button onclick="javascript:return alert('Data berhasil diedit, silahkan tunggu beberapa saat...')" type="submit" class="btn btn-success">Edit</button>  
                            </div>  
                          </div>  
                        </div>   
                    </form>
